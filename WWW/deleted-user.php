...
$users = $database->select("users", ['id','name','rfid_uid','del_rfid_uid'], ["status[=]" => 0]);
?>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 text-right p-3">
                <a href="users.php" class="btn btn-sm btn-success">View active user</a>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                foreach($users as $user)
                {
                    ...
                    echo '<td><a href="actions/userModel.php?act=active&rfid='.$user['del_rfid_uid'].'&id='.$user['id'].'" class="text-success txt_link">Make Active</a></td>';
                    echo '</tr>';
                }
                ?>
            </tbody>
