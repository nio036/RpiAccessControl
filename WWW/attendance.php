...
$users = $database->select("users", ['id','name',],["status[=]" => 1]);
...
<html lang="en">
    ...
    <nav class="navbar navbar-dark bg-dark">
        ...
        <ul class="nav nav-pills">
            <li class="nav-item">
                <a href="attendance.php" class="nav-link active">View Access</a>
            </li>
            <li class="nav-item">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 text-right p-3">
                <a href="deleted-attendance.php" class="btn btn-sm btn-danger">Deleted User Attendance</a>
            </div>
        </div>
